  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 px-4 mb-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Cash Out Entry</h2>
        <Link
          href="/admin/cash-out/list"
        ...
        <form className="space-y-6">
          ...
          <div className="relative">
            ...
            <textarea
              ...
              placeholder="Enter the purpose of cash out"
            ></textarea>
            <p className="mt-2 text-sm text-gray-500">
              Please provide a clear description of how the funds will be used.
            </p>
          </div>
